...
1.5. For a course target, run `student-wiki tracker focus {COURSE}`. When it returns the next exam or quiz, quiz its flagged concepts first and tell the student how many days are left
