...
4. After repairs, perform batch maintenance (update directly without further confirmation):
   ...
   - `wiki/hot.md` Upcoming section (run `student-wiki tracker hot`)
