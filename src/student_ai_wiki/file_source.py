...
Usage:
  student-wiki file <file> --course COMP6713 --type lecture
...
def main(argv=None) -> None:
    parser = argparse.ArgumentParser(prog="student-wiki file", description="File a course source into raw/ with provenance.")
