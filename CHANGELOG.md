...
Development before the first packaged release carried no tags or version numbers. From 0.1.0 on, releases follow [Semantic Versioning](https://semver.org) and the entries above are generated by [release-please](https://github.com/googleapis/release-please) from [Conventional Commits](https://www.conventionalcommits.org).
