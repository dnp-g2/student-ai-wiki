...
* the repository no longer doubles as a vault. Install with pipx install student-ai-wiki and create a vault with student-wiki init.

### Features

* package the tool as the student-wiki CLI ([b5a8b6e](https://github.com/dnp-g2/student-ai-wiki/commit/b5a8b6ed0942372df4f88fab8f9db31f9d1d4768))


### Documentation

* rewrite README for the packaged tool and add CONTRIBUTING, CHANGELOG and templates ([747ffae](https://github.com/dnp-g2/student-ai-wiki/commit/747ffaec82255c9b93c4681eb2954a0170b948a1))
